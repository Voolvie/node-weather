...
const forecast = (latitude,longitude, callback) => {
    ...
    request({url: urlWeather, json: true}, (error, {body})=>{
       if(error){
          ...
          callback(body.current.weather_descriptions[0] + '. It is currently ' + body.current.temperature + '. It feels like its ' + body.current.feelslike + ". Humidity is " + body.current.humidity + "%")
       }
